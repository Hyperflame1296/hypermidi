...
for (let i = 0; i < workerData.data.length; i++) {
    ...
    switch (sampleEvent.k) {
        case 'note':
            ...
            break
        case 'pitch':
            pitchbend[sampleEvent.c] = sampleEvent.v
            break
        case 'cc':
            switch (sampleEvent.n) {
                case 0x01: // modulation
                    cc.modulation[sampleEvent.c] = sampleEvent.v
                    break
                case 0x07: // volume
                    cc.volume[sampleEvent.c] = sampleEvent.v
                    break
                case 0x0b: // expression
                    cc.expression[sampleEvent.c] = sampleEvent.v
                    break
            }
            break
    }
